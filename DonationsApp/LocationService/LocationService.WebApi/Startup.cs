...
namespace LocationService.WebApi
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                options.RouteTemplate = "location/swagger/{documentName}/location.json";
            });
            app.UseSwaggerUI(
                options =>
                {
                    options.RoutePrefix = "location/swagger";
                    options.SwaggerEndpoint("v1/location.json", "Location Service");
                });
        }
    }
}
